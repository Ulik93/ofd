...
export default function Capabilities() {
    const items = [
        {name: "Безопасность", image: SecurityIcon, text: "Высокий уровень безопасности Ваших данных подтвержден сертификатом аттестации информационных систем по третьему классу защищенности"},
